...
int main(int argc, char *argv[]) { 
	...
	fputs("plot 'file1.dat' u 2:3 w lines \n ", pipe_gp1);
	fputs("set terminal png  size 1200,800\n ", pipe_gp1); 
	fputs("set output '2dplot1.png'\n ", pipe_gp1);
	fputs("replot\n ", pipe_gp1);
	...
	fputs("set ylabel 'Iteration Number'\n ", pipe_gp1);
	fputs("plot 'file2.dat' u 2:3 w lines \n ", pipe_gp1);
	fputs("set terminal png  size 1200,800\n ", pipe_gp1); 
	fputs("set output '2dplot2.png'\n ", pipe_gp1);
	fputs("replot\n ", pipe_gp1);
